...
The process of annotating user input files is associated with the "~/canvar/input_files" directory. NOTE: To perform annotation, files intended for annotation must be placed in the "~/canvar/input_files" directory.
